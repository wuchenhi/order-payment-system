...
public class UserController {
    ...
    public LoginResponse doLogin(@RequestBody UserLogin userLogin, HttpServletRequest request, HttpServletResponse
            response) {
        // 根据用户名查找user对象
...
//        }
        ...
        log.info("cookieValue:" + userTicket);
        //将用户信息存入redis
        ...
        // return userService.doLongin(userLogin, request, response);
}