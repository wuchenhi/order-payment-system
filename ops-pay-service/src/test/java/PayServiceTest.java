...
public class PayServiceTest {
    ...
    public void createPayment() throws IOException {
        Long orderId = 880856972411408384L;
        ShopPay pay = new ShopPay();
        pay.setOrderId(orderId);
        pay.setIsPaid(ShopCode.SHOP_ORDER_PAY_STATUS_NO_PAY.getCode());
        pay.setPayAmount(new BigDecimal(800));
        payService.createPayment(pay);
    }

    @Test
    public void callbackPayment() throws IOException {
        Long orderId = 880865452799168512L;
        Long payId = 880880650817773568L;

        ShopPay pay = new ShopPay();
        pay.setPayId(payId);
        pay.setOrderId(orderId);
        pay.setIsPaid(ShopCode.SHOP_ORDER_PAY_STATUS_IS_PAY.getCode()); //已经支付
